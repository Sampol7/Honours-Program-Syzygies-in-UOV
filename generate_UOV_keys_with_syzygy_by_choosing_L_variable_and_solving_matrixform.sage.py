...
# This file was *autogenerated* from the file generate_UOV_keys_with_syzygy_by_choosing_L_variable_and_solving_matrixform.sage
from sage.all_cmdline import *   # import sage library

_sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_2 = Integer(2); _sage_const_5 = Integer(5); _sage_const_3 = Integer(3); _sage_const_10 = Integer(10)
...
def generate_keys(k, n, m, order="deglex"):
    ...
    for i in range(m):
        x = R.gens()
        f = _sage_const_0 
        while f == _sage_const_0 :  # Ensure f is not the zero polynomial, otherwise not homogeneous
            f = _sage_const_0 
            for i in range(n - m):
                start_index = i
...
def generate_keys_with_syzygy(k, n, m, order="deglex"):
    ...
    while True:
        ...
        if any(poly!=R(_sage_const_0 ) for poly in L) :
            # If a syzygy is found, return the linear polynomials L1, ..., Lm
            return L, P, F, T
    ...
    for _ in range(iterations):
        ...
        for expr in L:
            ...
            for i in range(_sage_const_1 , n + _sage_const_1 ):
                ...
                if str(expr).find(variable_name) != -_sage_const_1 :
                    variable_count[variable_name] += _sage_const_1 
