...
# This file was *autogenerated* from the file attack_when_public_and_private_syzygies_are_given.sage
from sage.all_cmdline import *   # import sage library

_sage_const_2 = Integer(2); _sage_const_0 = Integer(0); _sage_const_1 = Integer(1); _sage_const_6 = Integer(6); _sage_const_5 = Integer(5); _sage_const_10 = Integer(10); _sage_const_0p1 = RealNumber('0.1')
import random
...
def find_possible_T(L, L_prime, n, m, q):
    ...
    T_vars = Matrix(SR, n, n, var('T_' + ',T_'.join([f'{i}{j}' for i in range(_sage_const_1 , n+_sage_const_1 ) for j in range(_sage_const_1 , n+_sage_const_1 )])))
