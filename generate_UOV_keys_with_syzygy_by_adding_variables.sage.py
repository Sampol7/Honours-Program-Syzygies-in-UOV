...
# This file was *autogenerated* from the file generate_UOV_keys_with_syzygy_by_adding_variables.sage
from sage.all_cmdline import *   # import sage library

_sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_0p7 = RealNumber('0.7'); _sage_const_2 = Integer(2); _sage_const_5 = Integer(5); _sage_const_3 = Integer(3)
...
def generate_keys_with_syzygy(k, n, m, random_ratio=_sage_const_0p7 , order="deglex"):
    """
    ...
    while L is None:
        ...
        R_ext = PolynomialRing(k, ["x%d" % i for i in range(_sage_const_1 , n+_sage_const_1 )] + [f'a_{i}_{j}' for i in range(m) for j in range(n)])
        ...
        def is_non_trivial_solution(solution):
            ...
            """
            for equation in solution:
                if equation.rhs() != _sage_const_0 :  # Check if the right-hand side is non-zero
                    return True
            return False
