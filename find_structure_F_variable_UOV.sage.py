...
# This file was *autogenerated* from the file find_structure_F_variable_UOV.sage
from sage.all_cmdline import *   # import sage library

_sage_const_3 = Integer(3); _sage_const_0 = Integer(0); _sage_const_97 = Integer(97); _sage_const_2 = Integer(2); _sage_const_5 = Integer(5); _sage_const_1 = Integer(1); _sage_const_10 = Integer(10); _sage_const_6 = Integer(6)#############################################
###Experiment 1
#############################################
...
for run in range(runs):
    ...
    R = PolynomialRing(k, ["x%d" % i for i in range(_sage_const_1 , n+_sage_const_1 )] + [f'f_{l}_{i}_{j}' for l in range(m) for i in range(n-m) for j in range(i, n)])
    x = R.gens()
