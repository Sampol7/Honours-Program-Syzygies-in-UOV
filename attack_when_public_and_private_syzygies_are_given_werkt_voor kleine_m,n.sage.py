...
# This file was *autogenerated* from the file attack_when_public_and_private_syzygies_are_given_werkt_voor kleine_m,n.sage
from sage.all_cmdline import *   # import sage library

_sage_const_2 = Integer(2); _sage_const_0 = Integer(0); _sage_const_1 = Integer(1); _sage_const_6 = Integer(6); _sage_const_100000 = Integer(100000); _sage_const_5 = Integer(5)# is_central_map returns true if all elements of the specified list of
