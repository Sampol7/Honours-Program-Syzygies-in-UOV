...
# This file was *autogenerated* from the file generate_UOV_keys_with_dependencies.sage
from sage.all_cmdline import *   # import sage library

_sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_2 = Integer(2); _sage_const_10 = Integer(10); _sage_const_5 = Integer(5); _sage_const_3 = Integer(3); _sage_const_31 = Integer(31); _sage_const_7 = Integer(7); _sage_const_14 = Integer(14); _sage_const_30 = Integer(30)
...
def find_solutions(I):
    dim = I.dimension()
    if dim < _sage_const_0  or dim > _sage_const_1 :
        # print("find_solutions with dim(I) = %d; returning []" % dim)
        return []
    elif dim == _sage_const_0 :
        return I.variety()
    # dimension 1
    sols = []
    R = I.gen(_sage_const_0 ).parent()
    x_i = R.gen(randint(_sage_const_0 , len(R.gens())-_sage_const_1 ))
...
def invert_central_map(F_polys, b, debug=False):
    R_x = F_polys[_sage_const_0 ].parent()
    k = R_x.base_ring()
    n = len(R_x.gens())
    m = len(F_polys)
...
def oilspace_y(k, n, m):
    basis = []
    for i in range(m):
        v = [_sage_const_0  for j in range(n)]
        v[n - i - _sage_const_1 ] = _sage_const_1 
        basis.append(v)
    return span(k, basis)
...
def test_central_map(F, num_tests=_sage_const_10 ):
    R = F[_sage_const_0 ].parent()
    k = R.base_ring()
    n = len(R.gens())
    m = len(F)
    ...
    for i in range(num_tests):
        ...
        for i in range(len(F)):
            ...
            assert F[i].subs(subs) == _sage_const_0 

# test_public_key ensures that the public key vanishes on the O_x.
def test_public_key(P, O_x, num_tests=_sage_const_10 ):
    R = P[_sage_const_0 ].parent()
    k = R.base_ring()
    for i in range(num_tests):
...
def run_tests():
    n = _sage_const_5 
    m = _sage_const_2 
    for q in [_sage_const_2 , _sage_const_3 , _sage_const_31 ]:
        k = GF(q, "z")
...
def sign_verify_example():
    ...
    P_polys, F_polys, A = generate_keys(GF(_sage_const_31 ), _sage_const_5 , _sage_const_2 )
    ...
    mu = [_sage_const_7 , _sage_const_14 ]
...
def pemutation_example():
    ...
    k = GF(_sage_const_31 )
    _, F_polys, _ = generate_keys(k, _sage_const_5 , _sage_const_2 )
    f = F_polys[_sage_const_0 ]
    F = poly_to_matrix(f)
    R = F_polys[_sage_const_0 ].parent()
    ...
    M_pi = matrix(k, [[_sage_const_1 , _sage_const_0 , _sage_const_0 , _sage_const_0 , _sage_const_0 ],
    [_sage_const_0 , _sage_const_0 , _sage_const_0 , _sage_const_1 , _sage_const_0 ],
    [_sage_const_0 , _sage_const_0 , _sage_const_1 , _sage_const_0 , _sage_const_0 ],
    [_sage_const_0 , _sage_const_1 , _sage_const_0 , _sage_const_0 , _sage_const_0 ],
    [_sage_const_0 , _sage_const_0 , _sage_const_0 , _sage_const_0 , _sage_const_1 ]])
    ...
    f_pi.subs({V["x1"]: _sage_const_1 , V["x3"]: _sage_const_1 , V["x4"]: _sage_const_1 }))
    print("f (1, 1, 1, x_4, x_5) =",
    f.subs({V["x1"]: _sage_const_1 , V["x2"]: _sage_const_1 , V["x3"]: _sage_const_1 }))
