...
# This file was *autogenerated* from the file distinguish_OUV_from_random_using_syzygies.sage
from sage.all_cmdline import *   # import sage library

_sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_2 = Integer(2); _sage_const_3 = Integer(3); _sage_const_6 = Integer(6); _sage_const_5 = Integer(5); _sage_const_10 = Integer(10); _sage_const_10000 = Integer(10000)
...
def test_number_of_lineair_syzygies(amount, k, n, m, order="deglex"):
    ...
    print(k.order()**(-_sage_const_6 *n*n))
...
test_number_of_lineair_syzygies(_sage_const_1 , GF(_sage_const_2 ), _sage_const_5 , _sage_const_3 , order="deglex")
...
def find_linear_dependency(F, k, n, m):
    ...
    def is_non_trivial_solution(solution):
        ...
        Checks if a solution to a system of equations is trivial (all variables are zero).
        """
        return any(s.rhs() != _sage_const_0  for s in solution)
...
def test_number_of_lineair_dependencies(amount, k, n, m, order="deglex"):
    ...
    print(k.order()**(-n))
    print("Theoretical Prob. 3")
    print(k.order()**(m-n*(n+_sage_const_1 )/_sage_const_2 +m*(m+_sage_const_1 )/_sage_const_2 ))
    ...
    print(k.order()**(-n))
    print("Theoretical Prob. 3")
    print(k.order()**(m-n*(n+_sage_const_1 )/_sage_const_2 ))
...
test_number_of_lineair_dependencies(_sage_const_10000 , GF(_sage_const_2 ), _sage_const_5 , _sage_const_3 , order="deglex")
