...
# This file was *autogenerated* from the file generate_UOV_keys_with_syzygy_by_choosing_F_variable_v3.sage
from sage.all_cmdline import *   # import sage library

_sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_2 = Integer(2); _sage_const_111 = Integer(111); _sage_const_10 = Integer(10); _sage_const_7 = Integer(7); _sage_const_6 = Integer(6)
...
def find_linear_dependency_in_R(L, k, n, m):
    ...
    solution = M.solve_right(vector(k, [_sage_const_0 ] * len(f_vars)))  # Solve the homogeneous system M * X = 0
...
time_dict = time_key_gen(_sage_const_10 , _sage_const_7 , _sage_const_6 )
